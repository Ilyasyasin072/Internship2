...
<tr>
<th colspan="3">No</th>
<th colspan="3">Jenis Tanaman</th>
<th colspan="3">pH tanaman</th>
<th colspan="3">Jumlah Nutrisi Tanaman (ppm)</th>
<?php $db = mysqli_query($db, "SELECT * FROM detailnutrisi") or die(mysqli_error($db));
if (mysqli_num_rows($db) > 0) {
    while ($data = mysqli_fetch_array($db)) {   
        ...
        <td align="center" colspan="3"><?=$data['jenis_tanaman'];?></td>
        <td align="center" colspan="3"><?=$data['ph'];?></td>
        <td align="center" colspan="3"><?=$data['ppm'];?></td>
        </tr>
        <?php
        $x++;
    }
