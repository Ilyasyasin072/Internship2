    ...
    <div class='box-login'>
      <form class="bingkai" action="proseslogin.php" method="POST">
                    <div>
                        ...
                        <input class="email" type="text" name="username" placeholder="Masukkan Username" required/>
                        <input class="passwd" type="password" name="password" placeholder="Masukkan Pasword" required/>
